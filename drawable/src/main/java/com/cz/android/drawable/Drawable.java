 ...
 *     through the {@link Callback2} interface.  All clients should support this
...
public abstract class Drawable {
    ...
    private WeakReference<Callback2> mCallback = null;
    ...
    public static interface Callback2 {
         ...
         * scheduled with {@link #scheduleDrawable2}.  An implementation can
    ...
    /**
     * Bind a {@link Callback2} object to this Drawable.  Required for clients
     ...
     * @see #getCallback()
     */
    public final void setCallback(Callback2 cb) {
        mCallback = new WeakReference<Callback2>(cb);
    }
    /**
     * Return the current {@link Callback2} implementation attached to this
     * Drawable.
     *
     * @return A {@link Callback2} instance or null if no callback was set.
     *
    ...
    /**
     * Use the current {@link Callback2} implementation to have this Drawable
     * redrawn.  Does nothing if there is no Callback attached to the
     * Drawable.
     *
     * @see Callback2#invalidateDrawable2
     * @see #getCallback()
     * @see # setCallback(android.graphics.drawable.Drawable.Callback)
     */
    public void invalidateSelf() {
        final Callback2 callback = getCallback();
        if (callback != null) {
            callback.invalidateDrawable2(this);
        }
    }
    /**
     * Use the current {@link Callback2} implementation to have this Drawable
     ...
     *
     * @see Callback2#scheduleDrawable2
     */
    public void scheduleSelf(Runnable what, long when) {
        final Callback2 callback = getCallback();
        if (callback != null) {
            callback.scheduleDrawable2(this, what, when);
        }
    }
    /**
     * Use the current {@link Callback2} implementation to have this Drawable
     ...
     *
     * @see Callback2#unscheduleDrawable2
     */
    public void unscheduleSelf(Runnable what) {
        final Callback2 callback = getCallback();
        if (callback != null) {
            callback.unscheduleDrawable2(this, what);
        }
    }
    /**
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Theme theme)
        ...
        if (theme != null) {
            a = theme.obtainStyledAttributes(
                    attrs, R.styleable.BaseDrawable, 0, 0);
        } else {
            a = r.obtainAttributes(attrs, R.styleable.BaseDrawable);
        }
        inflateWithAttributes(r, parser, a, R.styleable.BaseDrawable_base_visible);
        a.recycle();
    }
    /**
