...
*/
public class LayerDrawable extends Drawable implements Drawable.Callback2 {
    /**
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Theme theme)
        ...
        final TypedArray a = obtainAttributes(r, theme, attrs, R.styleable.RippleLayerDrawable);
    ...
    private void updateStateFromTypedArray(TypedArray a) {
        ...
        mOpacityOverride = a.getInt(R.styleable.RippleLayerDrawable_ripple_opacity, mOpacityOverride);
        state.mAutoMirrored = a.getBoolean(R.styleable.RippleLayerDrawable_ripple_autoMirrored,
                state.mAutoMirrored);
        state.mPaddingMode = a.getInteger(R.styleable.RippleLayerDrawable_ripple_paddingMode,
                state.mPaddingMode);
    }
    /**
    ...
    private void inflateLayers(Resources r, XmlPullParser parser, AttributeSet attrs, Theme theme)
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            final TypedArray a = obtainAttributes(r, theme, attrs, R.styleable.RippleLayerDrawableItem);
            updateLayerFromTypedArray(r,layer, a);
            a.recycle();
    ...
    private void updateLayerFromTypedArray(Resources r,ChildDrawable layer, TypedArray a) {
        final LayerState state = mLayerState;
        // Account for any configuration changes.
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
...
//        layer.mThemeAttrs = a.extractThemeAttrs();
        layer.mInsetL = a.getDimensionPixelOffset(
                R.styleable.RippleLayerDrawableItem_ripple_left, layer.mInsetL);
        layer.mInsetT = a.getDimensionPixelOffset(
                R.styleable.RippleLayerDrawableItem_ripple_top, layer.mInsetT);
        layer.mInsetR = a.getDimensionPixelOffset(
                R.styleable.RippleLayerDrawableItem_ripple_right, layer.mInsetR);
        layer.mInsetB = a.getDimensionPixelOffset(
                R.styleable.RippleLayerDrawableItem_ripple_bottom, layer.mInsetB);
        layer.mId = a.getResourceId(R.styleable.RippleLayerDrawableItem_ripple_id, layer.mId);
        int resourceId = a.getResourceId(R.styleable.RippleLayerDrawableItem_ripple_drawable, View.NO_ID);
        if (View.NO_ID != resourceId) {
            InputStream as = r.openRawResource(resourceId);
            XmlPullParser xmlPullParser = Xml.newPullParser();
            try {
                xmlPullParser.setInput(as,"utf-8");
                layer.mDrawable = Drawable.createFromXml(r, xmlPullParser);
...
//            final TypedArray a = t.resolveAttributes(state.mThemeAttrs, R.styleable.RippleLayerDrawable);
//            updateStateFromTypedArray(a);
//            a.recycle();
        }
...
//                        R.styleable.RippleLayerDrawableItem,true);
...
//            }
     ...
     */
    public ChildDrawable addLayer(Drawable layer, int[] themeAttrs, int id, int left, int top, int right,
            int bottom) {
