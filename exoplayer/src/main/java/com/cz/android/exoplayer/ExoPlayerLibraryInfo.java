...
public class ExoPlayerLibraryInfo {
  ...
  /**
   * Whether the library was compiled with {@link com.cz.android.exoplayer.util.Assertions}
   * checks enabled.
   */
  public static final boolean ASSERTIONS_ENABLED = true;

  /**
   * Whether the library was compiled with {@link com.cz.android.exoplayer.util.TraceUtil}
   * trace enabled.
   */
