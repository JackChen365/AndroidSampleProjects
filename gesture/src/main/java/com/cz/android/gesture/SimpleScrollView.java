 ...
 * is a {@link SimpleFrameLayout}, meaning you should place one child in it
 ...
 */
public class SimpleScrollView extends SimpleFrameLayout {
    private static final String TAG="SimpleScrollView";
    ...
    public SimpleScrollView(Context context, AttributeSet attrs, int defStyle) {
        ...
        initScrollView();
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SimpleScrollView, defStyle, 0);
        setFillViewport(a.getBoolean(R.styleable.SimpleScrollView_simpleFillViewport, false));
        a.recycle();
    }
    @Override
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (getChildCount() > 0) {
            ...
            if (child.getMeasuredHeight() < height) {
                final SimpleFrameLayout.LayoutParams lp = (LayoutParams) child.getLayoutParams();
    ...
    private int getScrollRange() {
        ...
        if (getChildCount() > 0) {
            ...
            scrollRange = Math.max(0,
                    child.getHeight() - (getHeight() - paddingBottom - paddingTop));
        }
        return scrollRange;
    }
    /**
    ...
    protected int computeVerticalScrollRange() {
        ...
        int paddingTop = getPaddingTop();
        int paddingBottom = getPaddingBottom();
        final int contentHeight = getHeight() - paddingBottom - paddingTop;
        if (count == 0) {
    ...
    public void scrollTo(int x, int y) {
        ...
        if (getChildCount() > 0) {
            ...
            y = clamp(y, getHeight() - paddingBottom - paddingTop, child.getHeight());
