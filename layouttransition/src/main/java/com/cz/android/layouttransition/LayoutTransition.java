...
public class LayoutTransition {
    ...
    private final Runnable changeAnimationRunnable=new Runnable() {
        @Override
        public void run() {
    ...
    private Runnable changingDisappearingRunnable=new Runnable() {
        @Override
        public void run() {
            startChangingAnimations();
        }
    ...
    private void setupChangeAnimation(final ViewGroup parent, final int changeReason,
        ...
        final View.OnLayoutChangeListener listener = new View.OnLayoutChangeListener() {
            public void onLayoutChange(View v, int left, int top, int right, int bottom,
                ...
                if("TransitionDemonstrateLayout".equals(simpleName)){
                    Log.i("onLayoutChange1","setupChangeAnimation:"+bottom+" oldBottom:"+oldBottom+" height:"+v.getHeight()+" reason:"+changeReason);
                }
                anim.setupEndValues();
                long startDelay = 0;
                switch (changeReason) {
                ...
                if (prevAnimation != null) {
                    ...
                    if("TransitionDemonstrateLayout".equals(simpleName)){
                        Log.i("onLayoutChange2","setupChangeAnimation:"+bottom+" oldBottom:"+oldBottom+" height:"+v.getHeight()+" reason:"+changeReason);
                    }
                }
...
//        if ((mTransitionTypes & FLAG_CHANGING) == FLAG_CHANGING  && !isRunning()) {
            if ((mTransitionTypes & FLAG_CHANGING) == FLAG_CHANGING) {
