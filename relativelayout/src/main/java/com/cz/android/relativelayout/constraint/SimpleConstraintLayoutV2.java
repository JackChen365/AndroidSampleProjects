package com.cz.android.relativelayout.constraint;
...
import com.cz.android.relativelayout.R;
 ...
 */
public class SimpleConstraintLayoutV2 extends ViewGroup {
    ...
    public static final int CHAIN_NONE=-1;
    public static final int CHAIN_SPREAD=0x00;
    public static final int CHAIN_SPREAD_INSIDE=0x01;
    public static final int CHAIN_SPREAD_PACKED=0x02;
    ...
    public SimpleConstraintLayoutV2(Context context) {
        super(context);
    }

    public SimpleConstraintLayoutV2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SimpleConstraintLayoutV2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private class DependencyGraph {
         ...
         * for this graph.
         */
        private LinkedList<Node> rootNodeList = new LinkedList<>();
        ...
        void verifyHierarchyGraph(int... rules) {
            final LinkedList<Node> roots = findRootList(rules);
            int index = 0;
         ...
         */
        private LinkedList<Node> findRootList(int[] rulesFilter) {
            ...
            final LinkedList<Node> roots = rootNodeList;
            roots.clear();
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == R.styleable.SimpleConstraintLayout_Layout_layout_simple_constraintLeft_toLeftOf) {
                    int id = a.getResourceId(attr, View.NO_ID);
                    addRule(LEFT_TO_LEFT, View.NO_ID!=id?id:a.getInt(attr, View.NO_ID));
                } else if (attr == R.styleable.SimpleConstraintLayout_Layout_layout_simple_constraintLeft_toRightOf) {
                    int id = a.getResourceId(attr, View.NO_ID);
                    addRule(LEFT_TO_RIGHT, View.NO_ID!=id?id:a.getInt(attr, View.NO_ID));
                } else if (attr == R.styleable.SimpleConstraintLayout_Layout_layout_simple_constraintTop_toTopOf) {
                    int id = a.getResourceId(attr, View.NO_ID);
                    addRule(TOP_TO_TOP, View.NO_ID!=id?id:a.getInt(attr, View.NO_ID));
                } else if (attr == R.styleable.SimpleConstraintLayout_Layout_layout_simple_constraintTop_toBottomOf) {
                    int id = a.getResourceId(attr, View.NO_ID);
                    addRule(TOP_TO_BOTTOM, View.NO_ID!=id?id:a.getInt(attr, View.NO_ID));
                } else if (attr == R.styleable.SimpleConstraintLayout_Layout_layout_simple_constraintRight_toRightOf) {
                    int id = a.getResourceId(attr, View.NO_ID);
                    addRule(RIGHT_TO_RIGHT, View.NO_ID!=id?id:a.getInt(attr, View.NO_ID));
                } else if (attr == R.styleable.SimpleConstraintLayout_Layout_layout_simple_constraintRight_toLeftOf) {
                    int id = a.getResourceId(attr, View.NO_ID);
                    addRule(RIGHT_TO_LEFT, View.NO_ID!=id?id:a.getInt(attr, View.NO_ID));
                } else if (attr == R.styleable.SimpleConstraintLayout_Layout_layout_simple_constraintBottom_toBottomOf) {
                    int id = a.getResourceId(attr, View.NO_ID);
                    addRule(BOTTOM_TO_BOTTOM, View.NO_ID!=id?id:a.getInt(attr, View.NO_ID));
                } else if (attr == R.styleable.SimpleConstraintLayout_Layout_layout_simple_constraintBottom_toTopOf) {
                    int id = a.getResourceId(attr, View.NO_ID);
