 ...
 *
 * @see #createDynamicHelper(RecyclerZoomLayout)
 * @see #createHorizontalHelper(RecyclerZoomLayout)
 * @see #createVerticalHelper(RecyclerZoomLayout)
 */
public abstract class OrientationHelper {
    protected final RecyclerZoomLayout layout;

    public static final int HORIZONTAL = LinearLayout.HORIZONTAL;

    public static final int VERTICAL = LinearLayout.VERTICAL;

    private OrientationHelper(RecyclerZoomLayout layout) {
        this.layout = layout;
    }
    ...
    public static class DynamicOrientationHelper extends OrientationHelper {
        ...
        public DynamicOrientationHelper(RecyclerZoomLayout layout, OrientationHelper horizontalHelper, OrientationHelper verticalHelper) {
            super(layout);
     ...
     */
    public static OrientationHelper createHorizontalHelper(RecyclerZoomLayout layout) {
     ...
     * @return A new OrientationHelper
     */
    public static OrientationHelper createVerticalHelper(RecyclerZoomLayout layout) {
        return new OrientationHelper(layout) {
